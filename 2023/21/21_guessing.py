...
def main():
  ...
  area = (farm.size.x + 1) * (farm.size.y + 1)
  free = area - len(farm.rocks)

  print(len(farm.rocks))
  print(free)
  print(area)

  steps = 26501365

  print("*** upper limit:", steps*(steps - 1)*free/area)
  print("*** still too high:", (steps - 1)*(steps - 1)*free/area)
  ...
  for i in range(1,edge + 1,2):
    farm.steps = i
    print("{:3} {:5}".format(i, len(farm.positions)))
  return
  # part 1
  farm.calculate_distances()
  farm.steps = 64
