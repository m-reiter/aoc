...
class Factory:
  ...
  def __eq__(self,other):
    return self.resources == other.resources and self.robots == other.robots and self.number == other.number
...
def part1(factories):
  for _ in range(24):
    ...
    for state in new_states:
      if state not in states and not any(state < other for other in new_states):
        factories.append(state)
    print(len(factories))
    #print(factories)
